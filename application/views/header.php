        ...
        <div class="navbar">                                
            <div class="navbar-inner">                                  
                ...
                <div class="nav-collapse collapse">                                     
                    <ul class="nav top-2">
                        <li class=""><a href="<?php echo base_url(); ?>">Главная</a></li>

                        <li class=""><a href="<?php echo base_url(); ?>tehplany">Техпланы</a></li>

                        <li class=""><a href="<?php echo base_url(); ?>megevanie">Межевание</a></li>

                        <li class=""><a href="<?php echo base_url(); ?>smety">Сметы</a></li>

                        <li class=""><a href="<?php echo base_url(); ?>company">О компании</a></li>

                        <li class=""><a href="<?php echo base_url(); ?>contacts">Контакты</a></li>
